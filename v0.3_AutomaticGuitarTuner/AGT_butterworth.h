...
double GAIN;
  ...
  double butterWorth_El(double input) {
    ...
    double butterWorth_A(double input) {
    ...
    double butterWorth_D(double input) {
     ...
     double butterWorth_G(double input) {
...
double butterWorth_B3(double input) {
...
GAIN = 3.314388598e+02;
  ...
  double butterWorth_Eh(double input) {
